...
public sealed class GetPublicJobsQuery
{
    ...
    /// <summary>
    /// When false, external/imported job listings are excluded from results.
    /// Defaults to true (external jobs are visible).
    /// </summary>
    public bool ShowExternalJobs { get; init; } = true;
