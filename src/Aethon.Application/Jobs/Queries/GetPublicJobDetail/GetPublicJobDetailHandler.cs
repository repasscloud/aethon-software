        ...
        ApplicantAgeGroup? viewerAgeGroup = null)
    {
        ...
        var raw = await _db.Jobs
            ...
            .Where(j => j.Id == jobId
                     ...
                     && (!j.IsSchoolLeaverTargeted || viewerAgeGroup == ApplicantAgeGroup.SchoolLeaver))
            .Select(j => new
            {
                j.Id,
                j.Title,
                ...
                OrgVerificationTier = j.OwnedByOrganisation.VerificationTier,
        ...
        var job = new PublicJobDetailDto
        {
            ...
            LocationCountryCode = raw.LocationCountryCode,
            ...
            Organisation = new PublicOrganisationProfileDto
            {
                ...
                VerificationTier = raw.OrgVerificationTier,
                IsVerified = raw.OrgVerificationTier != Aethon.Shared.Enums.VerificationTier.None,
