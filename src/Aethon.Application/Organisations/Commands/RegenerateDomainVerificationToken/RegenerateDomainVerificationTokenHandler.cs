...
namespace Aethon.Application.Organisations.Commands.RegenerateDomainVerificationToken;

public sealed class RegenerateDomainVerificationTokenHandler
{
    private readonly AethonDbContext _dbContext;
    private readonly ICurrentUserAccessor _currentUserAccessor;
    private readonly IDateTimeProvider _dateTimeProvider;

    public RegenerateDomainVerificationTokenHandler(
        ...
        CancellationToken ct = default)
    {
        ...
        domain.VerificationDnsRecordValue = recordValue;
        domain.VerificationRequestedUtc = utcNow;
