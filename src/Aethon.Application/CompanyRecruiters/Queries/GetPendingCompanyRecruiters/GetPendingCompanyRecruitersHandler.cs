...
namespace Aethon.Application.CompanyRecruiters.Queries.GetPendingCompanyRecruiters;

public sealed class GetPendingCompanyRecruitersHandler
{
    private readonly AethonDbContext _db;
    private readonly ICurrentUserAccessor _currentUser;

    public GetPendingCompanyRecruitersHandler(AethonDbContext db, ICurrentUserAccessor currentUser)
    {
        _db = db;
    ...
    public async Task<Result<List<RecruiterCompanyRelationshipDto>>> HandleAsync(CancellationToken ct = default)
    {
        ...
        var partnerships = await _db.OrganisationRecruitmentPartnerships
            ...
            .Where(p =>
                ...
                p.Status == OrganisationRecruitmentPartnershipStatus.Pending)
