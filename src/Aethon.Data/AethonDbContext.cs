    ...
    : IdentityDbContext<ApplicationUser, ApplicationRole, Guid>
{
    ...
    public DbSet<AtsMatchQueueItem> AtsMatchQueue => Set<AtsMatchQueueItem>();
    public DbSet<AtsMatchResult> AtsMatchResults => Set<AtsMatchResult>();

    protected override void OnModelCreating(ModelBuilder builder)
    {
        base.OnModelCreating(builder);

        builder.HasDefaultSchema("aethon");
