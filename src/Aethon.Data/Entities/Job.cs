...
public class Job : EntityBase
{
    ...
    /// <summary>
    /// Indicates this role is open to and suitable for school leavers (16–18 year olds).
    /// When true, school leavers may apply. When false, only adults (18+) may apply.
    /// </summary>
    public bool IsSuitableForSchoolLeavers { get; set; }

    /// <summary>
    /// Indicates this role specifically targets school leavers (16–18 year olds).
    /// When true, the job is only visible to authenticated job seekers with AgeGroup = SchoolLeaver.
    /// Implies IsSuitableForSchoolLeavers = true.
    /// </summary>
